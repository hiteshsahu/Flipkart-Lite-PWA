...
var SWPrecacheWebpackPlugin = function () {
  ...
  _createClass(SWPrecacheWebpackPlugin, [{
    ...
    value: function apply(compiler) {
      ...
      compiler.plugin('after-emit', function (compilation, callback) {
        ...
        _this.createServiceWorker().then(function (serviceWorker) {
          return _this.writeServiceWorker(serviceWorker, compiler, callback);
        }).then(_this.checkWarnings(compilation)).then(done, error);
      });
    }
  }, {
    key: 'configure',
    value: function configure(compiler, compilation) {
      ...
      var stripPrefixMulti = _extends({}, this.options.stripPrefixMulti);
    ...
    value: function writeServiceWorker(serviceWorker, compiler, callback) {
      ...
      return compiler.outputFileSystem.mkdirp(_path2.default.resolve(filepath, '..'), function () {
        return compiler.outputFileSystem.writeFile(filepath, serviceWorker, callback);
      });
    }
