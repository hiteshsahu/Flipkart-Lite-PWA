...
exports.default = defineConstants;
...
function addDefinePlugin(context) {
  ...
  return {
    plugins: [new context.webpack.DefinePlugin(stringifiedConstants)]
  };
}

function mapProps(object, valueMapper) {
  return Object.keys(object).map(propKey => ({ [propKey]: valueMapper(object[propKey]) })).reduce((newObject, partial) => Object.assign(newObject, partial), {});
}
//# sourceMappingURL=defineConstants.js.map